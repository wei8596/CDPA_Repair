...
const DESCRIPTION = {
	EN : '<p>\
			Please read the <a id="troubleCheck" href="" target="_blank">self-checking method</a> before you apply for fix request. You need to register for the first login. The account is used to help students confirm their request.   CDPA usually work from 19:00 to 21:00 on working day. Depending on the availability of our staff, it may take one to two weeks.\
        	</p>\
		',
	ZH : '<p>\
        	報修前請先詳閱<a id="troubleCheck" href="" target="_blank">自我檢查方法</a>確定報修前需進行登入，首次登入需進行註冊，帳號用於協助同學確認報修單處理狀況及更新報修單，CDPA跑單時間通常為平常日19:00~21:00，視當周CDPA服務同學的工作而定，報修後可能須等待一至兩周。\
        	</p>\
		',
